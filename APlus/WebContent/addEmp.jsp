...
<style>
 ...
 <body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle" style="width:20rem; border-radius:20px;">
		...
		<div class="card-body">
              <h5 class="form-signin-heading">교직원 추가</h5>
              <input type="text" id="old_pw" class="form-control" name="username" placeholder="교직원 ID" required autofocus><BR>
              <input type="text" id="new_pw" class="form-control" name="username" placeholder="이름" required autofocus><BR>
              
              <select id="employee">
              <option selected="selected" value="0">교수</option>
              <option value="1">교직원</option>
              </select>
             

              <button class="btn btn-lg btn-primary btn-block" onclick="addEmployee()" >추가</button>
