...
<body cellpadding="0" cellspacing="0" marginleft="0" margintop="0" width="100%" height="100%" align="center">
	...
	<div class="card align-middle"
		...
		<div class="card-body">
			...
			<button class="btn btn-lg btn-primary btn-block" onclick="login(0)">성적
				열람</button>
			<button class="btn btn-lg btn-primary btn-block" onclick="login(1)">학생
				추가</button>
			<button class="btn btn-lg btn-primary btn-block" onclick="login(0)">교직원
				추가</button>
